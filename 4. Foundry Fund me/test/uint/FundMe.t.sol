...
contract FundMeTest is Test {
    ...
    function testOwnerHasToBeMsgSender() public {
    ...
    function testMinimunEthForFund() public {
        vm.expectRevert();
        fundMe.fund(); // Send 0 value
    }

    function testUpdateFundedDataStructure() public {
        vm.prank(USER); // The next transaction is send by user
    ...
    function testWithdrawWithSignleFunder() public funded {
        //Arrange => Act => Assert (Use this methodology to test)
        // Arrange
        uint256 startingOwnerBalance = fundMe.getOwner().balance;
        uint256 startingFundMeBalance = address(fundMe).balance;

        //Act
        // uint256 gasStart = gasleft();  // Advance Gas stuff
